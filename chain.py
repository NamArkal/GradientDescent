...
def d_pow(operands, v):
    ...
    if(operands[0].value <= 0):
        return \
                operands[1].value * ((operands[0].value)**(operands[1].value - 1)) *\
                operands[0].derivative(v)
    else:
        return \
                operands[1].value * ((operands[0].value)**(operands[1].value - 1)) *\
                operands[0].derivative(v) + ((operands[0].value)**(operands[1].value) * math.log(operands[0].value) * operands[1].derivative(v))
